  ...
  return $.fn.mason = function(options, complete) {
    ...
    this.each(function() {
        ...
        setup = function() {
            ...
            elements.block.height = $view[0].offsetHeight/settings.numRows;
            ...
            //console.log(elements.block.height, elements.block.width, settings.numCols);
            sizeElements();
        ...
        layBricks = function() {
            var hGrid=$('.header_grid')[0].offsetHeight;
        ...
        while (r < elements.matrix.length) {
          ...
          r++;
            ...
            //console.log(77777777,$(settings.viewport).width(),$self.width() , elements.startWidth-2*elements.d);
