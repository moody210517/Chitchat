        ...
        '<div class="cookie-popup" style="display: none;">' +
            '<div class="cookie-popup-inner">' +
                ...
                '<div class="cookie-popup-right">' +
                    '<button class="cookie-popup-accept-cookies-btn btn small turquoise">Accept</button>'+
        ...
        acceptCookies : function(options) {
            ...
            if (!cookiesAccepted) {
                ...
                cookiePopup.find('.more_link').click(function(){
                    getPage([],this.href,false,true);
                    return false;
                })
                $('body').append(cookiePopup);
                $('.cookie-popup').delay(100).slideToggle();
                $('.cookie-popup-accept-cookies-btn').click(function(e) {
                    e.preventDefault();
                    saveCookie();
