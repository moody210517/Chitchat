...
function vids_render_page() {
    ...
    if (class_exists('CPage', false)) {
        ...
        $page->add($footer);
        $bheader = new CVidsHeader("vids_header", $g['tmpl']['dir_tmpl_main'] . "_vids_header.html");
        $page->add($bheader);
        $bside = new CVidsSide("vids_side", $g['tmpl']['dir_tmpl_main'] . "_vids_side.html");
        $page->add($bside);
        $bfooter = new CVidsFooter("vids_footer", $g['tmpl']['dir_tmpl_main'] . "_vids_footer.html");
        $page->add($bfooter);
    }
}
