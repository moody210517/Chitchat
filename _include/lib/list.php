...
class CHtmlList extends CHtmlBlock
{
	...
	{
		if ($this->m_debug == "Y") echo $this->m_sql_count . " WHERE " . $this->m_sql_where . ";<br />";

        if ($this->m_cache) $total = DB::result_cache($this->m_cache_name . "c", $this->m_cache_mins, $this->m_sql_count . " WHERE " . $this->m_sql_where . ";");
        else $total = DB::result($this->m_sql_count . " WHERE " . $this->m_sql_where . ";");
