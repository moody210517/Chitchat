...
//������� 
DB::execute("UPDATE ".$t_name." SET enemy=NULL, active='no', ingame='no', time_in=NULL, hod_data='empty' WHERE (login='".$_POST['myLogin']."' AND hod_data!='empty') OR (login='".$_POST['enemyLogin']."' AND hod_data!='empty')");
//������� ���� �� ���� � ��
