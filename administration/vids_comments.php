...
class CPage extends CHtmlBlock
{
	function parseBlock(&$html)
	{
        ...
        $pagerOnPage = 20;
        $pagerUrl = g('path','url_administration') . 'vids_comments.php?p=%s';

        $itemsTotal = CVidsTools::countCommentsNew();
        $items = CVidsTools::getCommentsNew((($page - 1) * $pagerOnPage) . ',' . $pagerOnPage);
...
$page = new CPage("main", $g['tmpl']['dir_tmpl_administration'] . "vids_comments.html");
