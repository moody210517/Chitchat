...
class CPage extends CHtmlBlock
{
	function parseBlock(&$html)
	{
        ...
        $pagerOnPage = 20;
        $pagerUrl = g('path','url_administration') . 'vids_videos.php?p=%s';

        CVidsTools::$admin = true;
        $itemsTotal = CVidsTools::countVideosAdmin();
        $items = CVidsTools::getVideosAdmin((($page - 1) * $pagerOnPage) . ',' . $pagerOnPage);
...
$page = new CPage("main", $g['tmpl']['dir_tmpl_administration'] . "vids_videos.html");
