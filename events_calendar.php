...
$page = new CEvents("", $g['tmpl']['dir_tmpl_main'] . "events_calendar.html");
...
$events_calendar = new CEventsCalendar("events_calendar", $g['tmpl']['dir_tmpl_main'] . "_events_calendar.html");
