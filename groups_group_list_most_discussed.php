...
$page = new CGroups("", $g['tmpl']['dir_tmpl_main'] . "groups_group_list_most_discussed.html");
...
$groups_sidebar->m_second_block = "recently_added";
...
$groups_group_list->m_list_type = "most_discussed";
