...
class CMusic extends CHtmlBlock
{
	...
	function parseBlock(&$html)
	{
		...
		if(!$this->m_music_musician_list->m_n_results && !$this->m_music_song_list->m_n_results)
        {
        	redirect("music_search.php?from=music_my");
        }
...
$page = new CMusic("", $g['tmpl']['dir_tmpl_main'] . "music_my.html");
...
$music_song_list->m_list_type = "by_user";
...
$music_musician_list->m_list_type = "by_user";
