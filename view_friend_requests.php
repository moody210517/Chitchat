...
class CFriendRequest extends CHtmlBlock
{
	...
	function parseBlock(&$html)
	{
		...
		if($request = DB::fetch_row())
		{
			...
			if ($friend['photo_id'] != "" and file_exists($g['path']['dir_files'] . "photo/" . $friend['user_id'] . "_" . $friend['photo_id'] . "_r.jpg")) $friend['photo'] = "photo/" . $friend['user_id'] . "_" . $friend['photo_id'] . "_" . $g['options']['main_users_photo_size'] . ".jpg";
